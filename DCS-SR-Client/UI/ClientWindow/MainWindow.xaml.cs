...
namespace Ciribob.DCS.SimpleRadio.Standalone.Client.UI.ClientWindow
{
    ...
    public MainWindow()
    {
        ...
        if (_globalSettings.GetClientSettingBool(GlobalSettingsKeys.StartMinimised))
        {
            ...
            Logger.Info("Started FS3D SRS Client " + Constants.VERSION + " minimized");
        }
        else
        {
            Logger.Info("Started FS3D SRS Client " + Constants.VERSION);
        }
    ...
    protected override void OnStateChanged(EventArgs e)
    {
        ...
        //         WindowState = WindowState.Minimized;
        //
        //         Logger.Info("Started DCS-SimpleRadio Client " + Constants.VERSION + " minimized");
        //     }
        //     else
        //     {
        //         Logger.Info("Started DCS-SimpleRadio Client " + Constants.VERSION);
        //     }
        //
        ...
        private void CurrentPosition_OnClick(object sender, MouseButtonEventArgs e)
        {
            try
            {
                var pos = ClientStateSingleton.Instance.PlayerCoaltionLocationMetadata.LngLngPosition;
