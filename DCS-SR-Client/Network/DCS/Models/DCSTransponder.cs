...
public class DCSTransponder
{
    ...
    public override bool Equals(object obj)
    {
        ...
        var compare = (DCSTransponder)obj;
    ...
    public DCSTransponder Copy()
    {
        return new DCSTransponder { mode1 = mode1, mode3 = mode3, mode4 = mode4, status = status, mic = mic };
    }
}